...
def get_insurance_distributor_details(
    distributor_key: str, base_url: str = INSURANCE_REGULATOR_SPAIN_URL, delay: float = 0.1
) -> dict[str, Any]:
    """
    ...
    params = {**mineco_params, "clave": distributor_key}
    ...
    details["auth_by_other_insurer"] = extract_label_value(soup, "Autorizada por otra entidad aseguradora:")
